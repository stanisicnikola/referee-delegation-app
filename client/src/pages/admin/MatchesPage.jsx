...
const MatchesPage = () => {
  ...
  const statsTotalMatches = statistics?.data?.total || 0;
  const totalMatches = data?.pagination?.total ?? matches.length;
          ...
          >
            <TablePagination
              ...
              sx={{
                ...
                color: COLORS.muted,
                "& .MuiTablePagination-selectIcon": { color: COLORS.muted },
                "& .MuiIconButton-root": { color: COLORS.muted },
